...
add_action('wp_enqueue_scripts', 'pelicanpawn_scripts', 100);
function pelicanpawn_scripts(){
  wp_register_script(
    'bootstrap-script', 
  ...
  wp_register_script(
    'jquery-libs', // lightslider and jquery mobile swiper
  ...
  wp_register_script(
    'pelicanpawn-scripts', 
    get_template_directory_uri() . '/js/pelicanpawn-scripts.js', 
    array('jquery'), 
    '', 
    true
  );
  ...
  wp_enqueue_script('pelicanpawn-scripts');  
}

add_action('wp_enqueue_scripts', 'pelicanpawn_styles');
function pelicanpawn_styles(){
  wp_register_style('bootstrap-css', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css');
  wp_register_style('google-fonts', '//fonts.googleapis.com/css?family=Raleway:400,500,700,900');
  wp_register_style('lightslider-css', get_template_directory_uri() . '/css/lightslider.min.css');
  wp_register_style('pelicanpawn', get_template_directory_uri() . '/style.css');
